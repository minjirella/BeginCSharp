...
namespace Database.Step4.Data
{
    ...
    public partial class ChinookEntities : DbContext
    {
        ...
        public virtual ObjectResult<Album_GetByPK_Result> Album_GetByPK(Nullable<int> albumId)
        {
            var albumIdParameter = albumId.HasValue ?
                new ObjectParameter("AlbumId", albumId) :
                new ObjectParameter("AlbumId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Album_GetByPK_Result>("Album_GetByPK", albumIdParameter);
        }
    }
}
